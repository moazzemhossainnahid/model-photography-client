...
const ContactStep = () => {
    return (
        <div className='container w-full'>
            <ol class="border-l-2 border-primary dark:border-primary-500 text-left">
                {/* <!--First item--> */}
                <li>
                    ...
                    <div class="mb-6 ml-6 pb-6">
                        ...
                        >4 February, 2022</a
                        >
                        <p class="mb-4 mt-2 text-neutral-600 dark:text-neutral-700">
                ...
                <li>
                    ...
                    <div class="mb-6 ml-6 pb-6">
                        ...
                        >12 January, 2022</a
                        >
                        <p class="mb-4 mt-2 text-neutral-600 dark:text-neutral-600">
                ...
                <li>
                    ...
                    <div class="mb-6 ml-6 pb-6">
                        ...
                        >27 December, 2021</a
                        >
                        <p class="mb-4 mt-2 text-neutral-600 dark:text-neutral-500">
