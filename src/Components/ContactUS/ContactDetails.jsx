        ...
        <div className="lg:flex">
          <div className="xl:w-2/5 lg:w-2/5 bg-primary py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
            <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
              ...
              <p className="text-xl text-left text-white pb-8 leading-relaxed font-normal lg:pr-4">
                <Bounce right>
          ...
          <div className="xl:w-3/5 lg:w-3/5 bg-gray-200 dark:bg-gray-600 h-full pt-5 pb-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br">
            ...
            >
                  ...
                  <Fade left>
                    <div className="flex flex-col">
                      ...
                      <input
                        ...
                        name="name"
                        type="text"
                        className="dark:bg-gray-900 dark:text-white dark:border-gray-700 focus:outline-none
              ...
              <div className="w-full lg:w-5/6 mt-6">
                ...
                <button
                  type="submit"
                  className="focus:outline-none bg-green-400 transition duration-150 ease-in-out hover:bg-primary rounded text-white px-8 py-3 text-sm leading-6 focus:border-4 focus:ring-2 focus:ring-offset-2 focus:ring-secondary"
                >
                  Submit
                </button>
              </div>
